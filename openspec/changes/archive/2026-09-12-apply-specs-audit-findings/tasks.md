...
- [x] 3.2 `deployment/helm-chart` — correct the Purpose's "four showcase services" (the spec deploys five, including
...
- [x] 4.2 Confirm each finding is resolved: the two titles match their paths; the helm-chart Purpose describes five
