...
policies, autoscaling, and observability wiring, together with the Gradle Helm-release configuration the chart is
deployed through (each release's namespace and the per-target kube context).
