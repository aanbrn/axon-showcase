...
auditors of the project-owned agent tooling (the guidance and project-authored `.opencode/` files), of the
`openspec/specs/` corpus, and of the architecture (the ADRs plus the service, module, and spec-decomposition surface).
