...
is not recorded), and of the human-facing `README.md` (its claims against the repository, its shape against the README
convention, and its coverage of the human-visible capabilities).
