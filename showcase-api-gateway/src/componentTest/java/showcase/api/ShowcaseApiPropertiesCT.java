...
class ShowcaseApiPropertiesCT {
    ...
    static List<Arguments> envVarBindings() {
        ...
        return List.of(
                argumentSet(
                        "FETCH_SHOWCASE_LIST_QUERY_CACHE_MAX_SIZE",
                        Map.of("FETCH_SHOWCASE_LIST_QUERY_CACHE_MAX_SIZE", "2000"),
                        (Consumer<ShowcaseApiProperties>) properties -> {
                            assertThat(cacheFor(properties, listCache).getMaximumSize())
                                    .isEqualTo(2000);
                        }),
                argumentSet(
                        "FETCH_SHOWCASE_LIST_QUERY_CACHE_EXPIRES_AFTER_ACCESS",
                ...
                argumentSet(
                        "FETCH_SHOWCASE_BY_ID_QUERY_CACHE_MAX_SIZE",
                        Map.of("FETCH_SHOWCASE_BY_ID_QUERY_CACHE_MAX_SIZE", "2000"),
                        (Consumer<ShowcaseApiProperties>) properties -> {
                            assertThat(cacheFor(properties, byIdCache).getMaximumSize())
                                    .isEqualTo(2000);
                        }),
                argumentSet(
