...
class ShowcaseDbSchedulerMetricsCT {
    ...
    void register_schedulerEvent_incrementsCounter() {
        ...
        assertThat(meterRegistry.counter("dbscheduler.schedulerEvents", "event", "UNEXPECTED_ERROR").count())
                .isEqualTo(1);
    }
    ...
    void register_candidateEvent_incrementsCounter() {
        ...
        assertThat(meterRegistry.counter("dbscheduler.candidateEvents", "event", "EXECUTED").count())
                .isEqualTo(1);
    }
    ...
    void register_executionEvent_incrementsCounter() {
        ...
        assertThat(meterRegistry.counter("dbscheduler.executionEvents", "event", "COMPLETED").count())
                .isEqualTo(1);
    }
