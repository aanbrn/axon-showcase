...
class ShowcaseQueryControllerIT {
    ...
    void fetchList_noFiltering_respondsWithAllShowcasesSortedByShowcaseIdInReverseOrder() {
        ...
        openSearchTemplate.save(
                showcases.stream().map(showcaseMapper::dtoToEntity).toList(),
    ...
    void fetchList_titleToFilterBy_respondsWithMatchingShowcasesSortedByShowcaseIdInReverseOrder() {
        ...
        val query = FetchShowcaseListQuery.builder().title(showcase.title()).build();
    ...
    void fetchList_singleStatusToFilterBy_respondsWithMatchingShowcasesSortedByShowcaseIdInReverseOrder() {
        ...
        val query = FetchShowcaseListQuery.builder().status(status).build();
    ...
    void fetchList_multipleStatusesToFilterBy_respondsWithMatchingShowcasesSortedByShowcaseIdInReverseOrder() {
        ...
        val query =
                FetchShowcaseListQuery.builder().status(status1).status(status2).build();
    ...
    void fetchList_afterId_respondsWithSubsequentShowcasesSortedByShowcaseIdInReverseOrder() {
        val showcases = showcases().stream()
        ...
        val query = FetchShowcaseListQuery.builder().afterId(afterId).build();
    ...
    void fetchList_size_respondsWithRequestedNumberOfShowcasesSortedByShowcaseIdInReverseOrder() {
        ...
        val query = FetchShowcaseListQuery.builder().size(size).build();
    ...
    void fetchList_invalidQuery_respondsWithBadRequestStatusAndProblemInBody() {
        ...
        webClient
                ...
                .isMap()
                .jsonPath("$.fieldErrors.afterId")
                .isArray()
                .jsonPath("$.fieldErrors.afterId[0]")
                .isNotEmpty()
                .jsonPath("$.fieldErrors.afterId[1]")
                .doesNotHaveJsonPath()
                .jsonPath("$.fieldErrors.size")
                .isArray()
                .jsonPath("$.fieldErrors.size[0]")
                .isNotEmpty()
                .jsonPath("$.fieldErrors.size[1]")
                .doesNotHaveJsonPath();
    }
    ...
    void fetchById_existingShowcase_respondsWithRequestedShowcase() {
        ...
        openSearchTemplate.save(
                requireNonNull(showcaseMapper.dtoToEntity(showcase)), showcaseIndexOperations.getIndexCoordinates());
    ...
    void fetchById_invalidQuery_respondsWithBadRequestStatusAndProblemInBody() {
        ...
        webClient
                ...
                .jsonPath("$.fieldErrors")
                .isMap()
                .jsonPath("$.fieldErrors.showcaseId")
                .isArray()
                .jsonPath("$.fieldErrors.showcaseId[0]")
                .isNotEmpty()
                .jsonPath("$.fieldErrors.showcaseId[1]")
                .doesNotHaveJsonPath();
    }
}
